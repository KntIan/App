<template>
    ...
    " :class="[
      ...
      isFullScreen && 'tui-search-h5-full-screen',
		...
		<div v-if="searchType === 'global'" ref="globalSearchRef"
          ...
          !isPC && 'tui-search-h5-global-header',
				...
				<SearchMore v-if="isPC || !searchingStatus" class="search-more" :searchType="searchType" />
			</div>
			<SearchContainer v-if="searchingStatus" class="search-container" popupPosition="bottom"
      ...
      " :class="[
        ...
        !isPC && 'tui-search-h5-conversation',
			...
			<SearchContainer class="search-container" popupPosition="aside"
				...
				<template #result>
					<SearchResult class="search-result" :searchType="searchType ? searchType : 'conversation'" />
				</template>
			</SearchContainer>
		</div>
	</div>
