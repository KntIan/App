		...
		<main class="main">
			<div class="left">
				<header class="transfer-header">
					...
					<input v-if="isPC && isTransferSearch" type="text" :value="searchValue"
						:placeholder="TUITranslateService.t('component.请输入userID')" enterkeyhint="search"
						:class="[isUniFrameWork ? 'left-uniapp-input' : '']" @keyup.enter="handleInput">
					<!-- not PC triggers blur -->
					<input v-if="!isPC && isTransferSearch" type="text"
						:placeholder="TUITranslateService.t('component.请输入userID')" enterkeyhint="search"
						:value="searchValue" :class="[isUniFrameWork ? 'left-uniapp-input' : '']" @blur="handleInput"
						@confirm="handleInput">
				</header>
				<main class="transfer-left-main">
					<ul class="transfer-list">
						<li v-if="optional.length > 1 && !isRadio" class="transfer-list-item" @click="selectedAll">
                ...
                TUITranslateService.t("component.全选")
						...
						<li v-for="item in transferList" :key="item.userID" class="transfer-list-item"
							@click="selected(item)">
                  ...
                  " onerror="this.onerror=null;this.src='https://web.sdk.qcloud.com/component/TUIKit/assets/avatar_21.png'">
						...
						<li v-if="transferTotal > transferList.length" class="transfer-list-item more" @click="getMore">
			...
			<div class="right">
				...
				<ul v-if="resultShow" class="transfer-list">
					...
					<li v-for="(item, index) in transferSelectedList" :key="index"
