...
// ../../../Project Folder/ZXHand/ZXHandwritting_APP_uniapp/node_modules/@tencentcloud/chat-uikit-engine/index.js
...
var M = "https://web.sdk.qcloud.com/component/TUIKit/assets/avatar_21.png";
var O = "https://web.sdk.qcloud.com/im/demo/TUIkit/web/img/constomer.svg";
...
var ee = class _ee {
  ...
  login(t2) {
    ...
    return this.createChat(t2), this.userID = i2, X.getInstance().initOfficial(a2), this.TUIStore.update(o.APP, "isOfficial", a2), this.TUIStore.update(o.APP, "SDKVersion", import_chat.default.VERSION), this.eventCenter = new r(this), this.eventCenter.removeEvents(), this.initStore(), this.initService(), s2 && s2.isReady() ? (console.log("TUIChatEngine.login ok, from TUICore."), this.TUIUser.getUserProfile(), this.checkCommercialAbility(), Promise.resolve({})) : (this.registerPlugin(t2), this.eventCenter.addEvent(this.EVENT.SDK_READY, () => {
      this.onSDKReady();
  ...
  initStore() {
    this.TUIStore.reset(o.CHAT), this.TUIStore.reset(o.CONV), this.TUIStore.reset(o.GRP), this.TUIStore.reset(o.USER), this.TUIStore.reset(o.SEARCH), console.log("TUIChatEngine.initStore ok.");
  }
  initService() {
...
var Ft = class _Ft extends ne {
  ...
  onMessageReceived(e2) {
    this.updateMessageList(e2, "push"), this.getEngine().TUIStore.update(o.CHAT, "newMessageList", e2);
  }
  onMessageModified(e2) {
  ...
  quoteMessage(e2) {
    return this.getEngine().TUIStore.update(o.CHAT, "quoteMessage", { message: e2, type: "quote" }), e2;
  }
  replyMessage(e2) {
  ...
  onMessageReceived(e2) {
    ...
    e2.forEach((e3) => {
      if (e3.type === t2.TYPES.MSG_GRP_TIP) {
        const { payload: s3 } = e3, { operationType: n2, userIDList: i2 } = s3, r2 = t2.TUIStore.getData(o.GRP, "currentGroupID");
        switch (n2) {
  ...
  Object.keys(s2).forEach((s3) => {
    ...
    t2[s3] = function() {
      ...
      return i2.use(function(t3, n3) {
        return e2.isInited ? n3() : Promise.reject({ code: h.NOT_INIT, message: `${s3} | ${d.NOT_INIT}` });
      }).use(function(e3, i3) {
...
console.log("TUIChatEngine.VERSION:2.3.2");
var Kt = ee.getInstance();
var qt = X.getInstance();
var zt = fe.getInstance();
var Jt = Dt.getInstance();
var Wt = Pt.getInstance();
var Xt = xt.getInstance();
var Zt = Ft.getInstance();
var Qt = $t.getInstance();
var es = Ht.getInstance();
Kt.mount(a.TUIStore, zt), Kt.mount(a.TUITranslate, Jt), Kt.mount(a.TUIConversation, Wt), Kt.mount(a.TUIUser, Xt), Kt.mount(a.TUIChat, Zt), Kt.mount(a.TUIGroup, Qt), Kt.mount(a.TUIFriend, es), Bt(Kt, Kt, f), Bt(Kt, Wt, m), Bt(Kt, Zt, v), Bt(Kt, Qt, T), Bt(Kt, Xt, E), Bt(Kt, es, I);
export {
  o as StoreName,
  Kt as TUIChatEngine,
  Zt as TUIChatService,
  Wt as TUIConversationService,
  es as TUIFriendService,
  qt as TUIGlobal,
  Qt as TUIGroupService,
  zt as TUIStore,
  Jt as TUITranslateService,
  Xt as TUIUserService,
  Kt as default
};
