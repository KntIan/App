<template>
  ...
  <view class="courseRegistrationCard">
    ...
    <view class="courseRegistrationCard_status">{{ online === 1 ? '线上' : '线下' }}</view>
...
export default {
  ...
  methods: {
    ...
    updateCountdown() {
      this.testHour = this.hours === '' ? 0 : this.hours;
      this.testMinute = this.minutes === '' ? 0 : this.minutes;
      this.testSecond = this.seconds === '' ? 0 : this.seconds;
