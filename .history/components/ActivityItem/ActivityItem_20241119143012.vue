<template>
  ...
  <view class="courseRegistrationCard">
    <view class="courseRegistrationCard_bg" v-if="hours !== 0 && minutes !== 0 && seconds !== 0"></view>
    <view class="courseRegistrationCard_status" v-if="hours !== 0 && minutes !== 0 && seconds !== 0">{{ online === 1 ? '线上' : '线下' }}</view>
