...
const fetchData = async () => {
  try {
    ...
    console.log(3, Array.isArray(listdataIndex), typeof listdataIndex); // 检查是否为数组及其内容 // 使用 .value 来获取实际的值
...
const updateCountdown = () => {
  ...
  console.log('listdata:', typeof listdataIndex);
  ...
  console.log('Updated listdata:', typeof listdataIndex);
