<template>
  <view class="class-group">
    ...
    <view style="padding: 0 28rpx;">
      <TUIChat1 @updateConversationListLength="handleLengthUpdate" />

    </view>
    <!-- <view class="kong" style="display: flex; justify-content: center; align-items: center; height: 100vh;">
