          ...
          <view class="input_po">
            <view class="input">
              <picker
                ...
                :value="giftindex"
                :range="giftArray && giftArray.map((item) => item.title)"
                :range-key="'gift'"
              >
          ...
          <view class="input_po">
            <view class="uni-list-cell-db input">
              <picker
                ...
                :value="multiIndex"
                :range="multiArray && multiArray.map((item) => item.title)"
...
const getlogin = async () => {
  try {
    ...
    if (avatarUrl.value) {
      ...
      if (response.code === 1) {
        store.registrationInformation.avatar = avatarUrl1.value
