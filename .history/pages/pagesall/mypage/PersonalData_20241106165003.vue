    ...
    <view class="form">
      ...
      <view class="input_po">
        <view class="uni-list-cell-db input">
          // <picker :disabled="isDisabled2" mode="multiSelector" @columnchange="onClassChange" :value="multiIndex" :range="multiArray.map(item => item.title)">
            // <view class="uni-input">
              // {{selectedValue }}
              // </view>
            // </picker>
          <picker mode="multiSelector" @change="onClassChange" :value="multiIndex" :range="multiArray.map(item => item.title)" :disabled="isDisabled2">
