<template>
  ...
  <view class="container">
    <view class="form">
      ...
      <view class="input_po">
        <view class="input">
          <picker :disabled="isDisabled1" @change="giftPickerChange($event, giftArray)" :value="giftindex" :range="giftArray.map(item => item.title)" :range-key="'gift'">
...
const giftPickerChange = (e, giftArray) => {
  ...
  console.log(giftindex.value)
  console.log(giftArray)
  console.log(giftArray.value[giftIndex.value].title)
  giftmoren.value = giftArray.value[giftIndex].title;
};
