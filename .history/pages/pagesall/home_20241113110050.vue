  ...
  text-overflow: ellipsis;">{{
          ...
          <view class="paddbox">
            ...
            <view class="huatibox">
              ...
              <text style="font-weight: 400; font-size: 24rpx; color: #666666">{{ item.add_time || '2022-01-01' }}</text>
            </view>
            <view class="huatibox">
        ...
        <view class="infoImg">
          <view class="proNum">
            <text style="font-weight: 400; font-size: 24rpx; color: #666666;margin-left: 6px;">
              {{ item.views }}人已观看
            </text>
