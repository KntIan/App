<template>
  <view class="homePage">
    ...
    <view class="showbox" v-for="(item, index) in studentAndstyle" :key="index">
      <view class="showimg">
        <img :src="item.logo" alt="" class="showimg1" />
      </view>
      <view class="showtext">
    ...
    <view class="works">
      ...
      <view class="worksImgs">
        <view class="worksimgbox" v-for="(item, index) in studentAndstyle.excellentWorks" :key="index">
    ...
    <view class="students" @click="linshi">
      ...
      <view class="stusImgs">
        <view class="stuimgbox" v-for="(item, index) in studentAndstyle.studentShowcase" :key="index">
      ...
      <view class="infolistbox" v-for="(item, index) in infoList" :key="index">
        <view class="infostr">
          <view class="huatibox">
            ...
            <text style="font-size: 32rpx; font-weight: 500;overflow: hidden;
  white-space: nowrap;
  text-overflow: ellipsis;">{{
          ...
          <view class="paddbox">
            ...
            <view class="huatibox">
              ...
              <text style="font-weight: 400; font-size: 24rpx; color: #666666;margin-left: 6px;">{{ item.add_time || '2022-01-01' }}</text>
            </view>
            <view class="huatibox">
...
const fetchData = async () => {
  try {
    ...
    infoList.value = responses[2].items.map(item => ({
      ...item,          // 保留原有的属性
    ...
    studentAndstyle.studentShowcase = responses[3].data.nice
    studentAndstyle.excellentWorks = responses[3].data.stud
    console.log(studentAndstyle.value)
    console.log(studentAndstyle.value.studentShowcase.value)
