		...
		<view class="chat_title_box">
			<view class="chat_title">
				...
				<view class="chat_head_img">
					<img src="https://lanhu-dds-backend.oss-cn-beijing.aliyuncs.com/merge_image/imgs/cf805a0bbe4b4f17abb1c215c9ec2df7_mergeImage.png"
						alt="" />
				</view>
		...
		<view class="chat-container">
				...
				<view v-for="(item, index) in messages_stu" :key="index" class="message-item_stu">
					...
					<view class="content1" :id="item.status == 'l' ? 'l' : 'r'">
						<view class="text" v-if="item.type=='img'">
							<img src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPng580a34d876cda0a5b37d451367934eb478865bb7b4b80bedde3f71fcaa5c8775"
								alt="" />
						</view>
			...
			<view class="input-container">
				<view class="chat_input">
					<img src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPng8336930e00a2e304b3bd63727ff79ab21eb7c0da57bcc1da2dc88adc00ef2cbe"
						alt="" @click="input_change" v-if="change" />
					<img src="../../../static/img/Frame.png" alt="" srcset="" @click="inputchange" v-else />
					<input v-model="inputMessage" placeholder="发消息..." @focus="scrollToBottom" confirm-type="send"
						@confirm="onSend" v-if="change" />

					<view class="voice" @touchstart="handleTouchStart" @touchend="handleTouchEnd" v-else>
						按住说话
					</view>
					<img src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPng59f0b59c28758e28c9970d6e3110b53be29f04b99fded460a8f2a1cd5b32d1da"
						alt="" class="btn_img" />
				</view>
