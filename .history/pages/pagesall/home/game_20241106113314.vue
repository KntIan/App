<template>
  ...
  <timeline v-for="(item,index ) in matchDetail.items.match_date.data" :key="index">
    <timelineItem :leftTime='item[index].title' color=" #84F257">
  ...
  methods: {
    async getMatchDetail(id) {
      try {
        ...
        console.log('获取到的比赛详情:', this.matchDetail.items);
      } catch (error) {
