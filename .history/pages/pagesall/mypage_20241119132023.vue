  ...
  methods: {
    async pa() {
      ...
      try {
        ...
        console.log('活动详情:', participatingActivities);

        // 假设 details 是一个数组，找到匹配的活动ID并且 hadSignup 为 1
        const matchedDetail = participatingActivities.items.find(detail =>
          detail.hadSignup === 1
        );
        ...
        if (matchedDetail) {
          ...
          this.participatingActivities = matchedDetail
