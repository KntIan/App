              ...
              <view class="listindex">
                ...
                <view class="actImg">
                  ...
                  <view class="acttime">
                    <text style="font-size: 24rpx;">距结束还剩:</text>
                    <view class="timetextbox">
                      <text style="font-size: 20rpx;padding: 3rpx 5rpx 3rpx 5rpx;border-radius: 5rpx;background-color:#999999;">{{ item.hours}}</text>
                      <text style="font-size: 20rpx;background-color:#fff;color: #F53C38;">:</text>
                      <text style="font-size: 20rpx;padding: 3rpx 5rpx 3rpx 5rpx;border-radius: 5rpx;background-color:#999999;">{{ item.minutes}}</text>
                      <text style="font-size: 20rpx;background-color:#fff;color: #F53C38;">:</text>
                      <text style="font-size: 20rpx;padding: 3rpx 5rpx 3rpx 5rpx;border-radius: 5rpx;background-color:#999999;">{{ item.seconds}}</text>
                    </view>
