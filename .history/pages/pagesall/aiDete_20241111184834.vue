...
let isReading = false; // 状态标志

const compressImageFile = (file) => {
  return new Promise((resolve, reject) => {
    if (isReading) {
      return reject(new Error("FileReader is busy. Please wait."));
    }
    isReading = true; // 设置为正在读取状态
