    ...
    <view class="titleHome">
      ...
      <view class="buttonImg">
        <view class="btnimg1" @click="btnscan">
          <imgage style="width: 36rpx;height: 36rpx;" src="../../static/img/saoma.png" alt="" />
        </view>
        <view class="btnimg2" @click="btnsearch">
          <imgage style="width: 36rpx;height: 36rpx;" src="@/static/img/sousuo.png" alt="" />
        </view>
        <view class="btnimg3" @click="btnmess">
          <imgage style="width: 36rpx;height: 36rpx;" src="@/static/img/xiaoxi.png" alt="" />
        </view>
      </view>
    </view>
    <view class="posit">
