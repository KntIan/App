    ...
    <view class="works">
      ...
      <view class="worksImgs">
        <view class="worksimgbox" v-for="(item, index) in studentAndstyle.nice" :key="index">
          <image style="width:198rpx;height:122rpx;margin-top:12rpx" :src="item.avatar" mode="aspectFill" />
        </view>
      </view>
    </view>
    ...
    <view class="students">
      ...
      <view class="stusImgs">
        <view class="stuimgbox" v-for="(item, index) in studentAndstyle.stud" :key="index">
          <image style="width:108rpx;height:108rpx;border-radius: 32px;margin-top: -4px;margin-left: -2px;" :src="item.sub_image" mode="aspectFill" />
