  ...
  <view class="homePage">
    <view class="titleHome">
      <view class="nameId">
        ...
        <view class="classID">{{userInfo.classly_id}}</view>
      </view>
    ...
    <view class="posit">
      ...
      <text class="postext">{{userInfo.school_id}}</text>
    </view>
...
const fetchData = async () => {
  try {
    ...
    infoList.value = responses[2].items.map(item => ({
      ...item,          // 保留原有的属性
      titleimg: item.titleimg || 'https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPng73002970eb6951969634d1ac818f9fbd983ad92340d21cf601ab0d495647806c'  // 添加 titleimg 属性，若没有则使用默认值
    }));
