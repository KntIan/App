<template>
  ...
  <div v-html="store.resultDivData" ref="resultsContainer" class="vertical-container"></div>
</template>
...
onMounted(() => {
  ...
  if (store.resultDivData) {
    newElement.innerHTML = store.resultDivData; // 根据实际内容决定使用 textContent 或 innerHTML
