...
// 定义响应式数据
const stu_List = ref([{ name: '刘琪琦', id: '1008601' }]);
...
const resultsContainer = ref(null); // 创建一个引用以访问DOM元素

onMounted(() => {
  // 访问 resultsContainer
  console.log('resultsContainer:', resultsContainer.value);

  // 创建一个新的元素并添加到 resultsContainer
  const newElement = document.createElement('div');
  newElement.appendChild(store.resultDivData); // 假设 store.resultDivData 是字符串
