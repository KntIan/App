...
function compressAndResizeImageFile(file, targetWidth, targetHeight) {
  return new Promise((resolve, reject) => {
    console.log('compressAndResizeImageFile', file);
    const fileSystemManager = uni.getFileSystemManager();
    console.log('171', fileSystemManager);
    // 读取文件
    fileSystemManager.readFile({
      ...
      success: (readFileRes) => {
        ...
        img.onload = function () {
          ...
          canvas.toTempFilePath({
            ...
            success: function (res) {
              // 用uni.getFileSystemManager()读取文件并返回
              fileSystemManager.readFile({
        ...
        img.src = 'data:image/jpeg;base64,' + readFileRes.data;
