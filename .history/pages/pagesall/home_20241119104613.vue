...
const goToDetail = (item) => {
  console.log('跳转到详情页面:', JSON.stringify(params.value))
  uni.navigateTo({
    url: `/pages/pagesall/home/informationDetailsmess?id=${item.id}&params=${params.value}` // 确保将 item.id 修改为您的详情页所需的参数
  });
};
const activityLists = () => {
