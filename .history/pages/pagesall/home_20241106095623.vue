        ...
        <view class="listindex">
          ...
          <view class="endbaoming">
            <view class="peopers">
              ...
              <view class="imgbox">
                <image v-for="(img, idx) in item.signup_member.items" :src="img.avatar ? img.avatar : ''" :key="idx" style="position: absolute; right: calc(20rpx * {{ idx }}); z-index: {{ 10 - idx }}; top: 10rpx; width: 30rpx; height: 30rpx; border-radius: 50%;" />
              </view>
            </view>
            <view class="perbtn">
              <view class="permoney">
