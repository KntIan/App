<template>
  <view class="homePage">
    <view class="titleHome">
      <view class="nameId">
        <view class="head">
          <image src="https://lanhu-dds-backend.oss-cn-beijing.aliyuncs.com/merge_image/imgs/dc222dae1c45493a96cd7da35e8a1a38_mergeImage.png" alt="" />
        </view>
        <view class="name">
      ...
      <view class="buttonImg">
        <view class="btnimg1" @click="btnscan">
          <image src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPng5e1b57899cb5b9cd47a8d4e301f4f736efd47c45ca7713a43d00721e94370714" alt="" />
        </view>
        <view class="btnimg2" @click="btnsearch">
          <image src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPng1bc2ffa456b6fda7ad06eee0d2a6f3efd0c7b823b9eeef0c186995bff9b22e4e" alt="" />
        </view>
        <view class="btnimg3" @click="btnmess">
          <image src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPngfb5a4b958665280ae8b1c0018d674845333615a9dc10f846fe95ad308c868f08" alt="" />
        </view>
      </view>
    </view>
    <view class="posit">
      <image src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPng5b0a65fd47f768b4c8f59ba6e2c415f9fe8dd593587d9ad6bbcd9f647066dc01" alt="" />
    ...
    <view class="showbox">
      <view class="showimg">
        <image src="https://lanhu-dds-backend.oss-cn-beijing.aliyuncs.com/merge_image/imgs/18d1eafb43df40dd8a2c22c0b95e5326_mergeImage.png" alt="" class="showimg1" />
      </view>
      <view class="showtext">
    ...
    <view class="actiClass">
      ...
      <view class="actitme" v-for="(item, index) in listdata" :key="index">
        ...
        <view class="listindex">
          ...
          <view class="actitmeText2">{{ item.description }}</view>
          ...
          <view class="endbaoming">
            <view class="peopers">
              <image src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPnge82cb54448fe7b82f1100cbe1494f08248762c97952c5f2a8f4b9a26a743a00a" alt="" />
              <view class="peotext" style="font-size: 20rpx">{{ item.signup_member.total }}人报名</view>
              <view class="imgbox">
                <image v-for="(img, idx) in item.signup_member.items" :src="img.avatar ? img.avatar : ''" :key="idx" style="position: absolute; right: calc(20rpx * {{ idx }}); z-index: {{ 10 - idx }};  width: 30rpx; height: 30rpx; border-radius: 50%;" />
              </view>
            </view>
            <view class="perbtn">
              <view class="permoney">
      ...
      <view class="infolistbox" v-for="(item, index) in infoList" :key="index">
        ...
        <view class="infoImg">
          <view class="proNum">
            ...
            <image :src="item.jiantouimg" alt="" style="width: 8rpx; height: 16rpx" />
          </view>
          <view class="proImg">
            <image :src="item.infoImg" alt="" />
          </view>
        </view>
      </view>
    </view>
...
const fetchData = async () => {
  try {
    ...
    infoList.value = responses[2].items
