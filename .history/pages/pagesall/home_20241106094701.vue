          ...
          <view class="endbaoming">
            <view class="peopers">
              ...
              <view class="imgbox">
                ...
                <image v-for="(img, idx) in item.signup_member.items" :src="img.avatar ? img.avatar : ''" :key="idx" style="position: absolute; right: calc(20rpx * {{ idx }}); z-index: {{ 10 - idx }};width:16px" />
              </view>
            </view>
            <view class="perbtn">
              <view class="permoney">
