<template>
  ...
  <video @play="playAudio" @pause="pauseAudio" @ended="stopAudio" class="learn_video" src="https://qiniu-web-assets.dcloud.net.cn/unidoc/zh/2minute-demo.mp4" muted='true'></video>
