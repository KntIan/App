<template>
  <view class="learn_title">
    ...
    <view>视频学习</view>
  </view>{{learnList.font_data.video}}
  <video @play="playAudio" @pause="pauseAudio" @ended="stopAudio" class="learn_video" :src="learnList.font_data.video" muted='true'></video>
  ...
  methods: {
    ...
    async loadHomeworkAudio() {
      try {
        ...
        if (this.learnList.length > 0 && this.learnList.font_data) {
          const audioSrc = this.learnList.font_data.voice_url; // 获取音频 URL
