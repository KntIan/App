      ...
      <uni-section title="实心标签" type="line">
        ...
        <view class="content">
          ...
          <view v-if="current === 0">
            ...
            <view v-else class="kong" style="display: flex; justify-content: center; align-items: center; height: 100px;">
              <image style="width: 100%;height: 100%;" src="@/static/img/noGro.png" mode="aspectFit" />
            </view>
