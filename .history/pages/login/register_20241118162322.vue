      ...
      <view class="form">
        ...
        <view style="margin-top: 24rpx;" class="textlogin">
          <view class="img1" @click="selectGender('男')">
            <img v-if="isMale" src="require('@/static/img/boy1.png')" alt="" />
            <img v-else src="~@/static/img/boy.png" alt="" />
            <view class="imgtext1"> 男 </view>
          </view>
          <view class="img2" @click="selectGender('女')">
            <img v-if="isFemale" src="~@/static/img/girl1.png" alt="" />
            <img v-else src="~@/static/img/girl.png" alt="" />
