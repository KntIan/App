...
// 获取班级数据
export const fetchClassData = (token, params) =>
  get('/user/classly', params, token)

// 获取校区数据
export const fetchCampusData = (token) => get('/user/school', {}, token)

//获取验证码
export const fetchVerificationCode = (token, data) =>
  post('/sms/send', data, token)
