	...
	<div :class="['tui-contact-search', !isPC && 'tui-contact-search-h5']">
        ...
        isSearching && 'tui-contact-searching-h5-header',
          ...
          !isPC && 'tui-contact-search-h5-header-icon',
				...
				<Icon :file="isSearching ? backSVG : addSVG" :width="isSearching ? '20px' : '14px'"
        ...
        !isPC && 'tui-contact-search-h5-main',
			...
			<input v-model="searchValue" class="tui-contact-search-main-input" type="text"
				:placeholder="searchingPlaceholder" enterkeyhint="search" @keyup.enter="search" @blur="search"
				@confirm="search">
