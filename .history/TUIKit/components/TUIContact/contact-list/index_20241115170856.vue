...
const selectedItems = ref(new Set()); // 使用 Set 存储已选中的 renderKey
...
onMounted(() => {
  console.log(contactListMap.contactListObj);
  //   contactListMap.contactListObj.value.list.forEach((contact) => {
  //     selectedItems.value.add(contact.renderKey); // 将每个联系人的 renderKey 添加到 Set 中
  //   });
