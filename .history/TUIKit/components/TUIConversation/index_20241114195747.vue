<template>
  <div class="tui-conversation" @click="handleClickConv" @touchstart="handleTouchStart" @touchend="handleTouchEnd">
    ...
    <ConversationNetwork />
    <ConversationList v-if="props.marker=== 'GROUP'" ref="conversationListDomRef" class="tui-conversation-list" @handleSwitchConversation="handleSwitchConversation" @getPassingRef="getPassingRef" :marker="props.marker" />
    <ConversationList1 v-if="props.marker=== 'C2C'" ref="conversationListDomRef1" class="tui-conversation-list" @handleSwitchConversation="handleSwitchConversation1" @getPassingRef="getPassingRef1" :marker="props.marker" />
...
import ConversationList1 from "./conversation-list/index1.vue";
...
const conversationListDomRef1 = ref<typeof ConversationList1>();
...
const closeChildren = () => {
  ...
  conversationListDomRef1?.value?.closeChildren();
};
...
const getPassingRef = (ref) => {
  ...
  ref.value = conversationListDomRef1.value;
};
</script>
