...
<<<<<<< HEAD
  <view class="homework_Title">
    ...
    <view class="homework_Title_text"> 我的课程 </view>
  </view>
  <swiper
  ...
  <view class="homeworktbox">
    <text class="box-text1">最近在看</text>
  </view>
  ...
  <view class="homeworktbox">
    <text class="box-text1">最新解锁</text>
  </view>
...
export default {
  ...
  methods: {
    async loadMyTemporaryHomework() {
      try {
        const response = await fetchMyCourseList(); // 调用 API 请求
...
=======
	...
	<swiper class="swiper-container" indicator-dots autoplay interval="3000" circular indicator-color="#ddd"
		indicator-active-color="#333">
