<template>
	...
	<bottom-sheet style="font-weight: 400;" :isVisible="isActionSheetVisible" :options="actionSheetOptions"
		...
		<view class="form">
			...
			<view class="input_po">
				...
				<image class="icon_1" referrerpolicy="no-referrer"
					...
					style="width: 28rpx; height: 28rpx;" @click="!isDisabled ? null : open()" />
			</view>
			<view class="title">校区</view>
			<view class="input_po">
				<view class="input">
					<picker :disabled="isDisabled1" @change="giftPickerChange($event, giftArray)" :value="giftindex"
				...
				<image class="icon_1" referrerpolicy="no-referrer"
					src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPng020f3b0f7825fdd6e79b0361c149b486540d9894e91feb72f43c076696f9d05f"
					style="width: 28rpx; height: 28rpx;" @click="togglePicker" />
			</view>
			...
			<view class="input_po">
				...
				<image class="icon_1" referrerpolicy="no-referrer"
					src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPng020f3b0f7825fdd6e79b0361c149b486540d9894e91feb72f43c076696f9d05f"
					style="width: 28rpx; height: 28rpx;" @click="togglePickerclass" />
			</view>
