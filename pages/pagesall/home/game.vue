			...
			<view class="infostr">
				...
				<view class="paddbox">
					...
					<view class="huatibox">
						...
						<text
							style="font-weight: 400;font-size: 24rpx;color: #666666;font-style: normal; margin-left: 10rpx;">{{item.infotime}}</text>
					</view>
	...
	<view class="event_site">
		...
		<view>
			<scroll-view class="scroll-view_H" scroll-x="true" @scroll="scroll" scroll-left="120" show-scrollbar="true">
				<view id="demo1" class="scroll-view-item_H uni-bg-red" v-for="(item, index) in site_imgList"
					:key="index"><img :src="item.site_img" alt="" />
					<view class="img_text">
						{{item.title}}
					</view>
				</view>
