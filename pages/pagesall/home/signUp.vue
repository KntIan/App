    ...
    <view class="homePage">
        ...
        <view class="actitme">
          ...
          <view class="listindex">
            ...
            <view class="actitmeText2"
              >报名人数：<text style="color: black; font-weight: bold"
                >{{ matchedDetails.signup_member.total }}人</text
              ></view
            >
            ...
            <view class="endbaoming">
              <view class="peopers">
                ...
                <view class="peotext" style="font-size: 20rpx"
                  >{{ matchedDetails.signup_member.total }}人报名</view
                >
                <view class="imgbox">
                  <image
                    v-for="(img, idx) in matchedDetails.signup_member.items"
      ...
      <view class="eventDetails">
        ...
        <div
          class="detaxiangqing"
          v-if="matchedDetails"
          v-html="matchedDetails.content"
        ></div>
        <!-- <web-view :src="htmlContentUrl" style="width: 100%; height: 100%" /> -->
        <!-- <view
          v-else
          class="kong"
          style="
