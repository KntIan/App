<template>
	...
	<view class="oper_area">
		...
		<view class="area_img">
			<img src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPng8115b2c160eee2c4a0b2d28b5170401ecd79f5c361abd0bc4f8a82f0af559654"
				alt="" />
			<view class="area_text">
				{{oper_area}}
			</view>
			<img src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPngf4e9bc406788b9232143810336e08dc7652f21137fb2a98411b6742d7f4dffb2"
				alt="" />
		</view>
		...
		<uni-section title="实心标签" type="line">
			...
			<view class="content">
				...
				<view v-if="current === 0">
					...
					<view class="oper_title_text1">
						往期回顾
					</view>
					<view class="actitme" v-for="(item,index) in listdata" :key="index">
						<view class="linetext" style="background-color: #999999;">
						...
						<view class="listindex">
							...
							<view class="actImg">
								...
								<view class="acttime">
									...
									<view class="timetextbox">
										<text
											style="font-size: 20rpx;padding: 3rpx 5rpx 3rpx 5rpx;border-radius: 5rpx;background-color:#999999;">{{ item.hours}}</text>
										<text style="font-size: 20rpx;background-color:#fff;color: #F53C38;">:</text>
										<text
											style="font-size: 20rpx;padding: 3rpx 5rpx 3rpx 5rpx;border-radius: 5rpx;background-color:#999999;">{{ item.minutes}}</text>
										<text style="font-size: 20rpx;background-color:#fff;color: #F53C38;">:</text>
										<text
											style="font-size: 20rpx;padding: 3rpx 5rpx 3rpx 5rpx;border-radius: 5rpx;background-color:#999999;">{{ item.seconds}}</text>
									</view>
							...
							<view class="endbaoming">
								<view class="peopers">
									<img src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPngbc0752e4c2b0c1556949591525f3b7f380e2ed3b52eb73e48c263c0f235e675f"
										alt="" />
