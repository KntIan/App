  ...
  <view>
    ...
    <view class="container">
      <view class="form">
        ...
        <view class="input">
          <picker
            @change="giftPickerChange"
            :value="giftIndex"
            :range="giftArray.map((item) => item.title)"
            :range-key="'gift'"
          >
        ...
        <view class="input">
          <picker
            ...
            :value="multiIndex"
            :range="multiArray.map((item) => item.title)"
            :disabled="isClassPickerDisabled"
          >
